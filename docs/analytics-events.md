...
Чтобы сопоставить заявку из почты/Telegram с визитом: посчитайте тот же хеш от тех же данных (email lower-case, телефон только цифры) и ищите UserID в отчётах Метрики / GA4.
