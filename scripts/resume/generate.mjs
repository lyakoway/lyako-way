        ...
        projects: [
          {
            ...
            details: [
              { label: "RAG pipeline", text: "индексация документов → разбиение на фрагменты (tiktoken) → embeddings (fastembed) → гибридный поиск BM25 + векторов (RRF) → генерация ответа LLM → цитирование источников." },
