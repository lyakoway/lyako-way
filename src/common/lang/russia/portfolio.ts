...
export const propsPortfolioList: PortfolioListProps[] = [
  {
    ...
    keyResultsNote:
      "Внутреннее использование в МТС (~2 000 документов, ~20 тыс. чанков). Эта страница — самостоятельное личное демо на публичном тестовом корпусе (6 файлов → 12 чанков), не исходный код МТС и не продовые документы.",
