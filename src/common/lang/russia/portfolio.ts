...
export const propsPortfolioList: PortfolioListProps[] = [
  {
    ...
    features: [
      ...
      "Оценка качества поиска: 24 golden-вопроса, Recall@1 94% (evaluation в README)",
