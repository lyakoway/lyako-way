...
const GlobalStyles = createGlobalStyle`
  ...
  *::before {
  ...
  :root {
    ...
    --typography-p4-bold-font-size: 10px;
    --typography-p4-bold-line-height: 12px;
    --typography-p4-bold-font-weight: 700;
    --typography-caption-wide-font-family: "MTS Wide";
    --typography-caption-medium-comp-font-family: 'MTS Compact';
  }
  ...
  html.light-theme {
    ...
    --color-background-primary-hover: #fafafa;
    ...
    --color-background-icons-secondary: #f2f3f7;
  ...
  html.dark-theme {
    ...
    --color-background-primary-hover: #1d2023;
    ...
    --color-background-icons-secondary: #969fa8;
  ...
  html, body {
    ...
    font-family: var(--typography-caption-medium-comp-font-family), sans-serif;
    font-size: 16px;
    color: var(--color-text-primary);
    -webkit-text-size-adjust: none;
    //https://www.terluinwebdesign.nl/en/css/position-sticky-not-working-try-overflow-clip-not-overflow-hidden/
    overflow-x: clip;
    --ecosystem-header-font-family: var(--typography-caption-medium-comp-font-family);
  }
  ...
  .mobileOnly {
    @media screen and (min-width: ${breakpoints.gridDxsBreakpoint}) {
      display: none !important;
    }
  }

  .desktopOnly {
    @media screen and (max-width: ${breakpoints.gridDxsBreakpoint}) {
      display: none !important;
    }
  }
