...
export const SidebarWrapper = styled.aside`
  ...
  @media (min-width: 1250px) {
    ...
    top: 60px;
    margin-bottom: 0;
    /* Отступы сверху и снизу одинаковые — карточка заканчивается сразу
       после контента, без пустого хвоста от бывшего min-height. */
    padding-top: 60px;
    padding-bottom: 60px;
    /* Фиксированная колонка: min-width:0 гасит min-content от имени без
       переносов, иначе при смене языка (русское имя длиннее английского)
       меняется ширина сайдбара и всего контента справа. */
    flex: 0 0 300px;
    min-width: 0;
  }
`;
...
export const Name = styled.h1`
  ...
  @media (min-width: 1250px) {
    /* Имя всегда в одну строку: nowrap + чуть меньший кегль — при 26px
       «Алексей Мазуренко» (≈239px) стоял ровно на границе inner-ширины
       колонки 300px (240px) и переносился от любого зума/округления. */
    white-space: nowrap;
    font-size: 24px;
    text-align: center;
  }
