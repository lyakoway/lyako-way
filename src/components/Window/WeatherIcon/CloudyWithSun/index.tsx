    ...
    >
      <g id="Cloud_3">
        <g id="White_cloud_3">
          ...
          />
          <circle id="XMLID_23_" fill="#ffffff" cx="17.4" cy="25.5" r="9.3" />
          <circle id="XMLID_22_" fill="#ffffff" cx="34.5" cy="23.9" r="15.6" />
          <animateTransform
        ...
        <g id="Sun_3">
          <circle id="XMLID_30_" fill="#ffeb3b" cx="31.4" cy="18.5" r="9" />
          <g>
            <path
              id="XMLID_31_"
              fill="#ffeb3b"
        ...
        <g id="Gray_cloud_3">
          ...
          />
          <circle id="XMLID_19_" fill="#e0e0e0" cx="46.7" cy="13.4" r="10.7" />
          <animateTransform
            attributeName="transform"
            attributeType="XML"
            dur="6s"
