...
// viewBox подрезан по рисунку: содержимое = 72% рамки. У остальных иконок 80%,
// но «Дом» и «Обо мне» — плотные заливки, они читаются крупнее контурных, и при
// одинаковой доле выглядели больше.
const HomeIcon = () => (
  <svg viewBox="-0.49 -1.08 24.98 24.98" aria-hidden>
    <path
